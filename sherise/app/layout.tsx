...
export const metadata: Metadata = {
  title: "SheRise - AI-Powered Career Comeback Platform",
  description: "Transform your career gap into your greatest comeback with AI-powered roadmaps and opportunities",
};
