...
export async function GET(
  ...
  try {
    ...
    // Generate today's tasks based on current step
    ...
    const eligibleOpportunities = opportunityMatches.filter(match => match.status === 'eligible').map(match => match.opportunity);
